...
const props = defineProps(['medicinecategory', 'id']);

const form = useForm({
    name: props.medicinecategory?.name ?? '',

    _method: props.medicinecategory?.id ? 'put' : 'post',
});
            ...
            <div class="flex items-center justify-between w-full text-gray-700 bg-gray-100 rounded-md">
                ...
                <div class="p-2 py-2 flex items-center space-x-2">
                    <div class="flex items-center space-x-3">
                        <button @click="goToMedicineCategoryList"
