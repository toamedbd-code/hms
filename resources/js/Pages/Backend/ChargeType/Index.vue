                            ...
                            <td v-for="module in allModules" :key="module"
                                ...
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" :checked="isModuleActive(item, module)"
                                        ...
                                        class="form-checkbox h-5 w-5 text-white rounded border-gray-300 focus:ring-blue-500 focus:ring-2 dark:bg-slate-700 dark:border-slate-500" />
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <a :href="route('backend.chargetype.edit', item.id)"
                                        class="px-3 py-1 rounded text-white font-semibold bg-yellow-400 text-black hover:bg-yellow-500">
                                        Edit
                                    </a>
