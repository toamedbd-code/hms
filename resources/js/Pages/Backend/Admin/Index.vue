...
let props = defineProps({
    filters: Object,
    roles: Array,
    permissions: Array, // Add permissions prop
});
            ...
            <div
                ...
                <div class="p-4 py-2 flex items-center space-x-2">
                    <div class="flex items-center space-x-3">
                        <!-- Conditionally show Staff Add button -->
                        <button 
                            v-if="hasPermission('admin-list-create')"
                            @click="goToAdminAdd"
                        ...
                        <!-- Conditionally show Role Add button -->
                        <div 
                            v-if="hasPermission('role-list-create')" 
