                    ...
                    <div class="grid grid-cols-1 gap-3 md:grid-cols-3 mb-4">
                        <div>
                            ...
                            <select id="record_type"
                                class="block w-full p-2 text-white rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200"
                    ...
                    <div v-if="isBirth" class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <textarea id="address" v-model="form.address" rows="2" placeholder="Address"
                                class="block w-full p-2 text-white rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200"></textarea>
