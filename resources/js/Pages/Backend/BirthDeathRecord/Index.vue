...
<script setup>
    ...
    const canCreateBirthDeathRecord = computed(() => userPermissions.value.includes('birthdeathrecord-create'));
    ...
    <template>
        <BackendLayout>
            ...
            <div
                ...
                <div
                    class="flex justify-between w-full p-4 space-x-2 text-white rounded shadow-md bg-slate-600 shadow-gray-800/50 dark:bg-gray-700 dark:text-gray-200">
                        ...
                        <div class="flex space-x-2">
                            <div class="w-full">
                                <input id="name" v-model="filters.name"
                                    class="block w-full p-2 text-white bg-gray-300 rounded shadow-sm border-slate-100 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600"
                    ...
                    <div class="hidden min-w-24 md:block">
                        <select v-model="filters.numOfData" @change="applyFilter"
                                class="w-full p-2 text-white bg-gray-300 rounded shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600">
                    ...
                    <div class="min-w-28 text-right">
                        <Link
                            v-if="canCreateBirthDeathRecord"
                            :href="route('backend.birthdeathrecord.create')"
