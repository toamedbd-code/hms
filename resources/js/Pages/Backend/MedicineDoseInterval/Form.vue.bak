...
const props = defineProps(['medicinedoseinterval', 'id']);

const form = useForm({
    name: props.medicinedoseinterval?.name ?? '',
    _method: props.medicinedoseinterval?.id ? 'put' : 'post',
});
