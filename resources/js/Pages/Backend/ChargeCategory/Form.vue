...
const props = defineProps(['chargecategory', 'id', 'chargeTypes']);

const form = useForm({
    charge_type_id: props.chargecategory?.charge_type_id ?? '',
    name: props.chargecategory?.name ?? '',
    description: props.chargecategory?.description ?? '',
            ...
            <div class="flex items-center justify-between w-full text-gray-700 bg-gray-100 rounded-md">
                ...
                <div class="p-2 py-2 flex items-center space-x-2">
                    <div class="flex items-center space-x-3">
                        <button @click="goToChargeCategoryList"
