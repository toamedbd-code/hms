    ...
    <div class="payment-section">
        ...
        <div class="summary-section">
            <table class="summary-table">
                ...
                @php
                    $taxOldOPD = round((float) ($tax_amount ?? 0), 2);
                    $discountOldOPD = round((float) ($discount_amount ?? 0), 2);
                @endphp
                @if ($taxOldOPD != 0)
                <tr>
                ...
                @php
                    $paidInvoiceTime = round((float) ($invoice_time_paid_amount ?? $paid_amount ?? 0), 2);
                    $totalPaidOld = round((float) ($paid_amount ?? 0), 2);
                    $balanceOld = round((float) ($balance_amount ?? 0), 2);
                @endphp
                @if ($paidInvoiceTime != 0)
                <tr>
