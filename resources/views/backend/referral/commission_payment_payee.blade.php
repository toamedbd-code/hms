...
<body>
    <div class="card">
        <div class="title">Payee Commission Payment</div>
        ...
        <form method="POST" action="{{ route('backend.referral.commission.payment.payee', $payee->id) }}">
            @csrf
            <div class="row">
                ...
                <div class="note">Max: ৳{{ number_format($pendingAmount ?? 0, 2) }}</div>
            </div>
            <div class="actions">
