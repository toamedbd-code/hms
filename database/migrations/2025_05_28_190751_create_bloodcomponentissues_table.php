...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('bloodcomponentissues', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('payment_mode', ['Cash', 'Card', 'Cheque', 'Insurance', 'TPA']);
    ...
    {
        Schema::dropIfExists('bloodcomponentissues');
    }
};
