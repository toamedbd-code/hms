...
<style>
    ...
    @media print {
        ...
        .footer-content-main, .footer-printed-at { pointer-events: none !important; color: #111 !important; }

        /* Reserve space at page bottom so content doesn't overlap/clip the footer */
        .content-section, .page, .sheet, .invoice-container, body {
            padding-bottom: calc(var(--report-footer-height) + 8mm) !important;
            overflow: visible !important;
        }
...
<div class="footer-wrapper" role="contentinfo">
    <div class="footer-image-area" aria-hidden="<?php echo e(empty($ftr) ? 'true' : 'false'); ?>">
        ...
        <?php if(!empty($footerContentVal)): ?>
            <div class="footer-content-area <?php echo e($footerContentPosition === 'below' ? 'below' : 'above'); ?>">
                <div class="footer-content-row">
                    <div class="footer-content-main"><?php echo $footerContentVal; ?></div>
                    <div class="footer-printed-at">Printing Date &amp; Time: <?php echo e($printedAt); ?></div>
                </div>
            </div>
        <?php endif; ?>
    </div>
