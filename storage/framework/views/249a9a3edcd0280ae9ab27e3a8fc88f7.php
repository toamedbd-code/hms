...
<head>
    ...
    <style>
        ...
        @media print {
            body {
                padding-top: <?php echo e($__inv_header_h + 10); ?>px; /* reserve space for fixed header */
    ...
    <div class="patient-info">
        <table class="patient-info-table">
            <tr>
                ...
                <td class="colon">:</td>
                <td class="value"><?php echo e($opd_id); ?></td>
                <td class="label">OPD Checkin ID</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($opd_checkin_id); ?></td>
            </tr>
            <tr>
                <td class="label">Patient Name</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($patient_name ?? ''); ?></td>
                <td class="label">Date</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($appointment_date ?? ''); ?></td>
            </tr>
            <tr>
                <td class="label">Blood Group</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($blood_group ?? '-'); ?></td>
                <td class="label">Age</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($age ?? ''); ?></td>
            </tr>
            <tr>
                <td class="label">Address</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($address ?? '-'); ?></td>
            ...
            <tr>
                ...
                <td class="colon">:</td>
                <td class="value"><?php echo e($consultant_doctor ?? ''); ?></td>
                <td class="label">Known Allergies</td>
                <td class="colon">:</td>
                <td class="value"><?php echo e($known_allergies ?? '-'); ?></td>
            </tr>
            <tr>
                <td class="label">Consultant Qualification</td>
                <td class="colon">:</td>
                <td class="value" colspan="4"><?php echo e($consultant_qualification ?? '-'); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="payment-section">
        ...
        <table class="payment-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><?php echo e(number_format($tax_percent, 2) . '(%)'); ?></td>
                    <td class="amount-col"><?php echo e(number_format($amount, 2)); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="summary-section">
            <table class="summary-table">
                <tr>
                    <td>Net Amount</td>
                    <td class="amount-col">Tk <?php echo e(number_format($amount, 2)); ?></td>
                </tr>
                <tr>
                    <td>Tax(<?php echo e(number_format($tax_percent, 2)); ?>%)</td>
                    <td class="amount-col">Tk <?php echo e(number_format($tax_amount, 2)); ?></td>
                </tr>
                <tr>
                    <td>Discount(<?php echo e(number_format($discount, 2)); ?>%)</td>
                    <td class="amount-col">Tk <?php echo e(number_format($discount_amount, 2)); ?></td>
                </tr>
                <tr class="total-row">
                    <td>Total</td>
                    <td class="amount-col">Tk <?php echo e(number_format($total_amount, 2)); ?></td>
                </tr>
                <tr>
                    <td>Paid (Invoice Time)</td>
                    <td class="amount-col">Tk <?php echo e(number_format($invoice_time_paid_amount ?? $paid_amount, 2)); ?></td>
                </tr>
                <?php $__currentLoopData = ($opd_due_collections ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dueCollection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="due-collect-label">
                        <?php echo e(\Carbon\Carbon::parse($dueCollection->collected_at)->format('d-M-Y h:i A')); ?> - Due Collect
                    </td>
                    <td class="amount-col">Tk <?php echo e(number_format((float) $dueCollection->collected_amount, 2)); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><strong>Total Paid Amount</strong></td>
                    <td class="amount-col"><strong>Tk <?php echo e(number_format($paid_amount, 2)); ?></strong></td>
                </tr>
                <tr class="balance-row">
                    <td>Due Amount</td>
                    <td class="amount-col">Tk <?php echo e(number_format($balance_amount, 2)); ?></td>
                </tr>
            </table>
        </div>
