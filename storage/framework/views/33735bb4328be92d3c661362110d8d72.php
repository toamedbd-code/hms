    ...
    <style>
        ...
        * {
        ...
        .footer-section {
            ...
            text-align: center;
            padding-bottom: 0px;
            min-height: <?php echo e($__inv_footer_h); ?>px;
            display: flex;
        ...
        @media print {
            ...
            .content-section {
                padding-bottom: <?php echo e($__inv_footer_h * 2); ?>px; /* reserve space for fixed footer */
            }
            ...
            .header-image { object-fit: cover; height: <?php echo e($__inv_header_h); ?>px; }
        ...
        @media print {
            ...
            .footer-section {
                min-height: <?php echo e($__inv_footer_h + 10); ?>px;
            }
        ...
        @media print and (max-height: 8.3in) and (max-width: 5.8in) {
            ...
            .footer-section {
                min-height: <?php echo e($__inv_footer_h); ?>px !important;
            }

            .footer-image {
                max-height: <?php echo e($__inv_footer_h + 10); ?>px !important;
            }
...
<body>
    <div class="invoice-container">
        ...
        <?php if ($__env->exists('prints.partials._header', [
        ...
        <div class="content-section">
            <table class="title-section-table">
                <tr>
                    <td class="barcode-cell-left">
                        <?php echo DNS1D::getBarcodeHTML(isset($bill) ? $bill->bill_no : $bill_number, 'C128', 1, 30); ?>
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="label">Age</td><td class="colon">:</td><td class="value"><?php echo e($age); ?></td>
                </tr>
                <tr>
            ...
            <table class="info-table">
                ...
                <tr>
                    <td class="label">Name</td><td class="colon">:</td><td class="value"><?php echo e($patient_name); ?></td>
                    <td class="label">Age</td><td class="colon">:</td><td class="value"><?php echo e($age); ?></td>
                </tr>
                <tr>
                    <td class="label">Contact No</td><td class="colon">:</td><td class="value"><?php echo e($contact_no); ?></td>
                    <td class="label">Gender</td><td class="colon">:</td><td class="value"><?php echo e($gender); ?></td>
                </tr>
                <tr>
            ...
            <!-- <div class="full-line-detail-row">
                ...
                <span class="full-line-value"><?php echo e($refd_by); ?></span>
            </div> -->
            ...
            <table class="items-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $bill_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="sl-col"><?php echo e($index + 1); ?></td>
                        <td class="test-col"><?php echo e($item->item_name ?? $item->description); ?></td>
                        <td class="qty-col"><?php echo e((int) $item->quantity); ?></td>
                        <td class="price-col"><?php echo e(number_format($item->total_amount, 2)); ?></td>
                    </tr>
...
<?php if(!isset($ipd_id) && $delivery_date): ?>
<div class="delivery-date">
    Delivery Date & Time:
    <?php echo e(Carbon::parse($delivery_date)->format('d-M-Y, h:i A')); ?>
...
<strong>Prepared By:</strong> <?php echo e($prepared_by); ?>
...
<?php if((isset($ipd_id) && (float) ($labTotal ?? 0) > 0)): ?>
<tr>
<td class="label-col">Laboratory Bill</td>
<td class="amount-col"><?php echo e(number_format($labTotal, 2)); ?></td>
</tr>
<?php endif; ?>

<tr>
<td class="label-col">Vat Tk.</td>
<td class="amount-col"><?php echo e(number_format($vat, 2)); ?></td>
</tr>

<?php if($discount_type == 'percentage'): ?>
<tr>
<td class="label-col">
Discount (<?php echo e(number_format($discount, 2)); ?>%)
</td>
<td class="amount-col">
<?php echo e(number_format(($total_amount * $discount / 100), 2)); ?>
...
<td class="amount-col"><?php echo e(number_format($discount, 2)); ?></td>
</tr>
<?php endif; ?>


<?php if($extra_flat_discount != 0): ?>
<tr>
<td class="label-col">Extra Discount Tk.</td>
<td class="amount-col">
<?php echo e(number_format($extra_flat_discount, 2)); ?>
...
<td class="amount-col">
<strong><?php echo e(number_format($netPayable,2)); ?></strong>
</td>
</tr>
...
<td class="amount-col">
<?php echo e(number_format($invoicePaid,2)); ?>
...
<?php $__currentLoopData = $dueCollections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
<td class="label-col" style="white-space: nowrap;">
<?php echo e(\Carbon\Carbon::parse($dc->collected_at)->format('d-M-Y h:i A')); ?> - Due Collect
</td>

<td class="amount-col" style="text-align:right;">
<?php echo e(number_format($dc->collected_amount, 2)); ?>
...
<?php if(!empty($return_amount) && (float) $return_amount > 0): ?>
<tr>
<td class="label-col"><strong>Return Amount Tk.</strong></td>
<td class="amount-col">
<strong><?php echo e(number_format((float) $return_amount,2)); ?></strong>
</td>
</tr>
<?php endif; ?>
...
<td class="amount-col">
<strong><?php echo e(number_format($finalDue,2)); ?></strong>
</td>
</tr>
