...
const _sfc_main = {
  ...
  props: ["chargetaxcategory", "id"],
  setup(__props) {
    var _a, _b, _c;
    const props = __props;
    const form = useForm({
      name: ((_a = props.chargetaxcategory) == null ? void 0 : _a.name) ?? "",
      percentage: ((_b = props.chargetaxcategory) == null ? void 0 : _b.percentage) ?? "",
      _method: ((_c = props.chargetaxcategory) == null ? void 0 : _c.id) ? "put" : "post"
    });
    const submit = () => {
      const routeName = props.id ? route("backend.chargetaxcategory.update", props.id) : route("backend.chargetaxcategory.store");
      form.transform((data) => ({
        ...data,
        remember: "",
        isDirty: false
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<input id="percentage" class="block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600"${ssrRenderAttr("value", unref(form).percentage)} type="text" placeholder="Percentage"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              class: "mt-2",
              message: unref(form).errors.percentage
            }, null, _parent2, _scopeId));
                  ...
                  createVNode("div", { class: "p-2 py-2 flex items-center space-x-2" }, [
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      createVNode("button", {
                        ...
                        createTextVNode(" Charge Tax List ")
                      ])
                    ])
                  ])
                ]),
                  ...
                  createVNode("div", { class: "grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4" }, [
                    ...
                    createVNode("div", { class: "col-span-1 md:col-span-1" }, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        [vModelText, unref(form).percentage]
                      ]),
                      createVNode(_sfc_main$3, {
                        class: "mt-2",
                        message: unref(form).errors.percentage
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/ChargeTaxCategory/Form.vue");
