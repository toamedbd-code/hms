...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const form = useForm({
      name: ((_a = props.ambulance) == null ? void 0 : _a.name) ?? "",
      _method: ((_b = props.ambulance) == null ? void 0 : _b.id) ? "put" : "post"
    });
    ...
    const submit = () => {
      const routeName = props.id ? route("backend.ambulance.update", props.id) : route("backend.ambulance.store");
      form.transform((data) => ({
        ...data,
        remember: "",
        isDirty: false
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/Ambulance/Form.vue");
