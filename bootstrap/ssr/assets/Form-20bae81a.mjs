...
const _sfc_main = {
  ...
  props: ["annualcalendar", "id"],
  setup(__props) {
    var _a, _b;
    const props = __props;
    const form = useForm({
      name: ((_a = props.annualcalendar) == null ? void 0 : _a.name) ?? "",
      _method: ((_b = props.annualcalendar) == null ? void 0 : _b.id) ? "put" : "post"
    });
    ...
    const submit = () => {
      const routeName = props.id ? route("backend.annualcalendar.update", props.id) : route("backend.annualcalendar.store");
      form.transform((data) => ({
        ...data,
        remember: "",
        isDirty: false
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/AnnualCalendar/Form.vue");
