...
const _sfc_main = {
  ...
  props: ["frontoffice", "id"],
  setup(__props) {
    var _a, _b;
    const props = __props;
    const form = useForm({
      name: ((_a = props.frontoffice) == null ? void 0 : _a.name) ?? "",
      _method: ((_b = props.frontoffice) == null ? void 0 : _b.id) ? "put" : "post"
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/FrontOffice/Form.vue");
