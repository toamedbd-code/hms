import { ref, onMounted, withCtx, createVNode, toDisplayString, openBlock, createBlock, createTextVNode, withDirectives, vModelText, vModelSelect, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const filters = ref({
      ...
      from_date: ((_b = props.filters) == null ? void 0 : _b.from_date) ?? "",
      to_date: ((_c = props.filters) == null ? void 0 : _c.to_date) ?? "",
      staff_id: ((_d = props.filters) == null ? void 0 : _d.staff_id) ?? "",
      name: ((_e = props.filters) == null ? void 0 : _e.name) ?? ""
    });
    const applyFilter = () => {
      router.get(route("backend.staffattendance.index"), filters.value, { preserveState: true });
    };
                  ...
                  createVNode("div", { class: "p-4 py-2 flex items-center space-x-2" }, [
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      createVNode("button", {
                        ...
                        createTextVNode(" Attendance Add ")
                      ])
                    ])
                  ])
                ]),
                createVNode("div", { class: "flex justify-between w-full p-2 py-3 space-x-2 text-gray-700 rounded-md bg-slate-300" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/StaffAttendance/Index.vue");
