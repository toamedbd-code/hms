import { ref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createTextVNode, createCommentVNode, withDirectives, vModelText, vModelSelect, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const filters = ref({
      ...
      email: ((_b = props.filters) == null ? void 0 : _b.email) ?? "",
      phone: ((_c = props.filters) == null ? void 0 : _c.phone) ?? "",
      role_id: ((_d = props.filters) == null ? void 0 : _d.role_id) ?? "",
      numOfData: ((_e = props.filters) == null ? void 0 : _e.numOfData) ?? 10
    });
    const applyFilter = () => {
      router.get(route("backend.admin.index"), filters.value, { preserveState: true });
    };
    const goToAdminAdd = () => {
      router.visit(route("backend.admin.create"));
    };
    const goToRoleList = () => {
      router.visit(route("backend.role.index"));
    };
    const goToRoleAdd = () => {
      router.visit(route("backend.role.create"));
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full p-2 duration-1000 ease-in-out bg-white rounded-md dark:bg-slate-900"${_scopeId}><div class="flex mb-2 items-center justify-between w-full text-gray-700 bg-gray-100 rounded-md dark:bg-gray-800 dark:text-gray-200 shadow-gray-800/50"${_scopeId}><div${_scopeId}><h1 class="p-4 text-xl font-bold dark:text-white"${_scopeId}>${ssrInterpolate(_ctx.$page.props.pageTitle)}</h1></div><div class="p-4 py-2 flex items-center space-x-2"${_scopeId}><div class="flex items-center space-x-3"${_scopeId}>`);
            if (hasPermission("admin-list-create")) {
              _push2(`<button class="inline-flex items-center justify-center px-4 py-2.5 text-sm font-semibold text-white border-0 rounded-md shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 active:scale-95 transform transition-all duration-150 ease-in-out" style="${ssrRenderStyle({ "background": "linear-gradient(to right, #3b82f6, #60a5fa)" })}"${_scopeId}><svg class="w-4 h-4 mr-2 -ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"${_scopeId}></path></svg> Staff Add </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (hasPermission("role-list-view")) {
              _push2(`<button class="inline-flex items-center justify-center px-4 py-2.5 text-sm font-semibold text-white border-0 rounded-md shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 active:scale-95 transform transition-all duration-150 ease-in-out" style="${ssrRenderStyle({ "background": "linear-gradient(to right, #3b82f6, #60a5fa)" })}"${_scopeId}><svg class="w-4 h-4 mr-2 -ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"${_scopeId}></path></svg> Role List </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (hasPermission("role-list-create")) {
              _push2(`<div class="flex items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-1 shadow-inner"${_scopeId}><button class="inline-flex items-center justify-center px-4 py-2.5 text-sm font-semibold text-white border-0 rounded-md shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 active:scale-95 transform transition-all duration-150 ease-in-out" style="${ssrRenderStyle({ "background": "linear-gradient(to right, #3b82f6, #60a5fa)" })}"${_scopeId}><svg class="w-4 h-4 mr-2 -ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"${_scopeId}></path></svg> Role Add </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="flex justify-between w-full p-2 py-3 space-x-2 text-gray-700 rounded-md bg-slate-300 shadow-gray-800/50 dark:bg-gray-700 dark:text-gray-200"${_scopeId}><div class="grid w-full grid-cols-1 gap-2 md:grid-cols-5"${_scopeId}><div class="flex space-x-2"${_scopeId}><div class="w-full"${_scopeId}><input id="name"${ssrRenderAttr("value", filters.value.name)} class="block w-full p-2 text-sm rounded-md border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600" type="text" placeholder="Name"${_scopeId}></div><div class="block min-w-24 md:hidden"${_scopeId}><select class="w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600"${_scopeId}><option value="10"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "10") : ssrLooseEqual(filters.value.numOfData, "10")) ? " selected" : ""}${_scopeId}>Show 10</option><option value="20"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "20") : ssrLooseEqual(filters.value.numOfData, "20")) ? " selected" : ""}${_scopeId}>Show 20</option><option value="30"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "30") : ssrLooseEqual(filters.value.numOfData, "30")) ? " selected" : ""}${_scopeId}>Show 30</option><option value="40"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "40") : ssrLooseEqual(filters.value.numOfData, "40")) ? " selected" : ""}${_scopeId}>Show 40</option><option value="100"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "100") : ssrLooseEqual(filters.value.numOfData, "100")) ? " selected" : ""}${_scopeId}>Show 100</option><option value="150"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "150") : ssrLooseEqual(filters.value.numOfData, "150")) ? " selected" : ""}${_scopeId}>Show 150</option><option value="500"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "500") : ssrLooseEqual(filters.value.numOfData, "500")) ? " selected" : ""}${_scopeId}>Show 500</option></select></div></div><div class=""${_scopeId}><input id="phone"${ssrRenderAttr("value", filters.value.phone)} class="block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600" type="text" placeholder="phone"${_scopeId}></div><div class=""${_scopeId}><input id="email"${ssrRenderAttr("value", filters.value.email)} class="block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600" type="text" placeholder="Email"${_scopeId}></div><div class=""${_scopeId}><select class="block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(filters.value.role_id) ? ssrLooseContain(filters.value.role_id, "") : ssrLooseEqual(filters.value.role_id, "")) ? " selected" : ""}${_scopeId}>Choose A Role</option><!--[-->`);
            ssrRenderList(__props.roles, (roleInfo) => {
              _push2(`<option${ssrRenderAttr("value", roleInfo.id)}${ssrIncludeBooleanAttr(Array.isArray(filters.value.role_id) ? ssrLooseContain(filters.value.role_id, roleInfo.id) : ssrLooseEqual(filters.value.role_id, roleInfo.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(roleInfo.name)}</option>`);
            });
            _push2(`<!--]--></select></div></div><div class="hidden min-w-24 md:block"${_scopeId}><select class="w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600"${_scopeId}><option value="10"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "10") : ssrLooseEqual(filters.value.numOfData, "10")) ? " selected" : ""}${_scopeId}>show 10</option><option value="20"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "20") : ssrLooseEqual(filters.value.numOfData, "20")) ? " selected" : ""}${_scopeId}>show 20</option><option value="30"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "30") : ssrLooseEqual(filters.value.numOfData, "30")) ? " selected" : ""}${_scopeId}>show 30</option><option value="40"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "40") : ssrLooseEqual(filters.value.numOfData, "40")) ? " selected" : ""}${_scopeId}>show 40</option><option value="100"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "100") : ssrLooseEqual(filters.value.numOfData, "100")) ? " selected" : ""}${_scopeId}>show 100</option><option value="150"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "150") : ssrLooseEqual(filters.value.numOfData, "150")) ? " selected" : ""}${_scopeId}>show 150</option><option value="500"${ssrIncludeBooleanAttr(Array.isArray(filters.value.numOfData) ? ssrLooseContain(filters.value.numOfData, "500") : ssrLooseEqual(filters.value.numOfData, "500")) ? " selected" : ""}${_scopeId}>show 500</option></select></div></div><div class="w-full my-3 overflow-x-auto"${_scopeId}>`);
                ...
                createVNode("div", { class: "flex mb-2 items-center justify-between w-full text-gray-700 bg-gray-100 rounded-md dark:bg-gray-800 dark:text-gray-200 shadow-gray-800/50" }, [
                  ...
                  createVNode("div", { class: "p-4 py-2 flex items-center space-x-2" }, [
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      hasPermission("admin-list-create") ? (openBlock(), createBlock("button", {
                        key: 0,
                        onClick: goToAdminAdd,
                        ...
                        onMouseout: _ctx.handleMouseOut
                      }, [
                        ...
                        createTextVNode(" Staff Add ")
                      ], 40, ["onMouseover", "onMouseout"])) : createCommentVNode("", true),
                      hasPermission("role-list-view") ? (openBlock(), createBlock("button", {
                        key: 1,
                      ...
                      hasPermission("role-list-create") ? (openBlock(), createBlock("div", {
                        key: 2,
                        class: "flex items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-1 shadow-inner"
                      }, [
                        createVNode("button", {
                          onClick: goToRoleAdd,
                          class: "inline-flex items-center justify-center px-4 py-2.5 text-sm font-semibold text-white border-0 rounded-md shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 active:scale-95 transform transition-all duration-150 ease-in-out",
                ...
                createVNode("div", { class: "flex justify-between w-full p-2 py-3 space-x-2 text-gray-700 rounded-md bg-slate-300 shadow-gray-800/50 dark:bg-gray-700 dark:text-gray-200" }, [
                  createVNode("div", { class: "grid w-full grid-cols-1 gap-2 md:grid-cols-5" }, [
                    ...
                    createVNode("div", { class: "" }, [
                      withDirectives(createVNode("input", {
                        id: "phone",
                        "onUpdate:modelValue": ($event) => filters.value.phone = $event,
                        class: "block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600",
                        type: "text",
                        placeholder: "phone",
                        onInput: applyFilter
                      }, null, 40, ["onUpdate:modelValue"]), [
                        [vModelText, filters.value.phone]
                      ])
                    ]),
                    createVNode("div", { class: "" }, [
                      withDirectives(createVNode("input", {
                        id: "email",
                        "onUpdate:modelValue": ($event) => filters.value.email = $event,
                        class: "block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600",
                        type: "text",
                        placeholder: "Email",
                        onInput: applyFilter
                      }, null, 40, ["onUpdate:modelValue"]), [
                        [vModelText, filters.value.email]
                      ])
                    ]),
                    createVNode("div", { class: "" }, [
                      withDirectives(createVNode("select", {
                        "onUpdate:modelValue": ($event) => filters.value.role_id = $event,
                        onChange: applyFilter,
                        class: "block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600"
                      }, [
                        createVNode("option", { value: "" }, "Choose A Role"),
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.roles, (roleInfo) => {
                          return openBlock(), createBlock("option", {
                            value: roleInfo.id
                          }, toDisplayString(roleInfo.name), 9, ["value"]);
                        }), 256))
                      ], 40, ["onUpdate:modelValue"]), [
                        [vModelSelect, filters.value.role_id]
                      ])
                    ])
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/Admin/Index.vue");
