...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const form = useForm({
      name: ((_a = props.bedtype) == null ? void 0 : _a.name) ?? "",
      _method: ((_b = props.bedtype) == null ? void 0 : _b.id) ? "put" : "post"
    });
    const submit = () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/BedType/Form.vue");
