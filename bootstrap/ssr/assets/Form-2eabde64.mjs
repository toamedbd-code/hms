...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const form = useForm({
      name: ((_a = props.certificate) == null ? void 0 : _a.name) ?? "",
      _method: ((_b = props.certificate) == null ? void 0 : _b.id) ? "put" : "post"
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/Certificate/Form.vue");
