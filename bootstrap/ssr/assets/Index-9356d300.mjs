                    ...
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      createVNode("div", { class: "flex items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-1 shadow-inner" }, [
                        createVNode("button", {
                          ...
                          createTextVNode(" Charge Unit Add ")
                        ])
                      ])
                    ])
                  ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/ChargeUnitType/Index.vue");
