...
const _sfc_main$1 = {
  ...
  props: {
    ...
    contentClasses: {
      type: Array,
      default: () => ["py-1", "bg-slate-100 dark:bg-slate-800 text-slate-800"]
    }
  },
  setup(__props) {
    const props = __props;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div style="${ssrRenderStyle(unref(open) ? null : { display: "none" })}" class="fixed inset-0 z-40"></div><div style="${ssrRenderStyle([
        ...
        { "display": "none" }
      ])}" class="${ssrRenderClass([[widthClass.value, alignmentClasses.value], "absolute z-50 mt-4 rounded-md shadow-lg"])}"><div class="${ssrRenderClass([__props.contentClasses, "rounded-md ring-1 ring-black ring-opacity-5"])}">`);
