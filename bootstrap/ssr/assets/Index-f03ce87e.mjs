...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const applyFilter = () => {
      router.get(route("backend.role.index"), filters.value, { preserveState: true });
    };
    const goToRoleAdd = () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/Role/Index.vue");
