...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const applyFilter = () => {
      router.get(route("backend.applyleave.index"), filters.value, { preserveState: true });
    };
                  ...
                  createVNode("div", { class: "p-4 py-2 flex items-center space-x-2" }, [
                    ...
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      createVNode("button", {
                        ...
                        createTextVNode(" All Leave List ")
                      ])
                    ]),
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      createVNode("button", {
                    ...
                    createVNode("div", { class: "flex space-x-2" }, [
                      createVNode("div", { class: "w-full" }, [
                        withDirectives(createVNode("input", {
                          id: "title_en",
                          "onUpdate:modelValue": ($event) => filters.value.employee_name = $event,
                          class: "block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600",
                          type: "text",
                          placeholder: "Employee Name",
                          onInput: applyFilter
                        }, null, 40, ["onUpdate:modelValue"]), [
                          [vModelText, filters.value.employee_name]
                        ])
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/ApplyLeave/Index.vue");
