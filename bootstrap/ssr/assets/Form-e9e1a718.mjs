...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const form = useForm({
      name: ((_a = props.floor) == null ? void 0 : _a.name) ?? "",
      description: ((_b = props.floor) == null ? void 0 : _b.description) ?? "",
      _method: ((_c = props.floor) == null ? void 0 : _c.id) ? "put" : "post"
    });
    const submit = () => {
      const routeName = props.id ? route("backend.floor.update", props.id) : route("backend.floor.store");
      form.transform((data) => ({
        ...data,
        remember: "",
        isDirty: false
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="col-span-3 md:col-span-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "description",
              value: "Description"
            }, null, _parent2, _scopeId));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/Floor/Form.vue");
