...
import { _ as _sfc_main$1 } from "./AuthenticationCardLogo-95cd6bf0.mjs";
import { _ as _sfc_main$5 } from "./Checkbox-74b17051.mjs";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.errorMessage) {
              _push2(`<div class="mb-4 text-sm font-medium text-red-600"${_scopeId}>${ssrInterpolate(__props.errorMessage)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.successMessage) {
              _push2(`<div class="mb-4 text-sm font-medium text-green-600"${_scopeId}>${ssrInterpolate(__props.successMessage)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.warningMessage) {
              _push2(`<div class="mb-4 text-sm font-medium text-red-600"${_scopeId}>${ssrInterpolate(__props.warningMessage)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`<span class="text-sm text-gray-600 ms-2"${_scopeId}>Remember me</span></label></div><div class="flex items-center justify-end mt-4"${_scopeId}>`);
            ...
            return [
              ...
              __props.warningMessage ? (openBlock(), createBlock("div", {
                key: 2,
                class: "mb-4 text-sm font-medium text-red-600"
              }, toDisplayString(__props.warningMessage), 1)) : createCommentVNode("", true),
              createVNode("form", {
