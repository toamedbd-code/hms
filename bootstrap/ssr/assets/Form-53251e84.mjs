...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const form = useForm({
      type_name: ((_a = props.Leavetype) == null ? void 0 : _a.type_name) ?? "",
      days: ((_b = props.Leavetype) == null ? void 0 : _b.days) ?? "",
      imagePreview: ((_c = props.Leavetype) == null ? void 0 : _c.image) ?? "",
      filePreview: ((_d = props.Leavetype) == null ? void 0 : _d.file) ?? "",
      _method: ((_e = props.Leavetype) == null ? void 0 : _e.id) ? "put" : "post"
    });
    const submit = () => {
      const routeName = props.id ? route("backend.Leavetype.update", props.id) : route("backend.Leavetype.store");
      form.transform((data) => ({
        ...data,
        remember: "",
        isDirty: false
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<input id="days" class="block w-full p-2 text-sm rounded-md shadow-sm border-slate-300 dark:border-slate-500 dark:bg-slate-700 dark:text-slate-200 focus:border-indigo-300 dark:focus:border-slate-600"${ssrRenderAttr("value", unref(form).days)} type="text" placeholder="Days"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              class: "mt-2",
                    ...
                    createVNode("div", { class: "p-2 py-2 flex items-center space-x-2" }, [
                      createVNode("div", { class: "flex items-center space-x-3" }, [
                        createVNode("button", {
                          ...
                          createTextVNode(" Leave Type List ")
                        ])
                      ])
                    ])
                  ])
                  ...
                  createVNode("div", { class: "grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4" }, [
                    createVNode("div", { class: "col-span-1 md:col-span-2" }, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        "onUpdate:modelValue": ($event) => unref(form).type_name = $event,
                        type: "text",
                        placeholder: "Type name"
                      }, null, 8, ["onUpdate:modelValue"]), [
                        [vModelText, unref(form).type_name]
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/LeaveType/Form.vue");
