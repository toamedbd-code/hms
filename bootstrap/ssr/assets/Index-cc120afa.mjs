...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const applyFilter = () => {
      router.get(route("backend.invoicedesign.index"), filters.value, { preserveState: true });
    };
    const goToInvoiceDesignAdd = () => {
                    ...
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      createVNode("div", { class: "flex items-center bg-gray-50 dark:bg-gray-800 rounded-lg p-1 shadow-inner" }, [
                        createVNode("button", {
                          ...
                          createTextVNode(" Invoice Design Add ")
                        ])
                      ])
                    ])
                  ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/InvoiceDesign/Index.vue");
