                  ...
                  createVNode("div", { class: "p-4 py-2 flex items-center space-x-2" }, [
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      createVNode("button", {
                        ...
                        createTextVNode(" Designation Add ")
                      ])
                    ])
                  ])
                ]),
                  ...
                  createVNode("div", { class: "grid w-full grid-cols-1 gap-2 md:grid-cols-5" }, [
                    ...
                    createVNode("div", { class: "" }, [
                      withDirectives(createVNode("select", {
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(_ctx.roles, (roleInfo) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Backend/Designation/Index.vue");
